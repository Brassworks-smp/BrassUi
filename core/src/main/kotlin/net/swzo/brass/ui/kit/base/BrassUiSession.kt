...
object BrassUiSession {
    ...
    /**
     * Reset every per-session global. Called when a screen closes, and by tests between cases.
     *
     * Does not touch the theme ([net.swzo.brass.ui.Colors.theme]) or the bound platform: those are
     * application configuration, not per-screen state, and resetting them would undo the mod's setup.
     */
    fun reset() {
