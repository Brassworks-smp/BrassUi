...
interface BrassKeyLayer {
    ...
    /**
     * A key was pressed while this layer is on screen. Return true to consume it.
     *
     * Consume narrowly. This runs before *everything*, so a layer that swallows keys it does not use
     * makes the rest of the screen unresponsive while it is open.
     */
