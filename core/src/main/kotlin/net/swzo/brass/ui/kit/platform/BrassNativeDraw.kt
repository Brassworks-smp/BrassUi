...
fun interface BrassNativeDraw {
    ...
    /**
     * Paint into a [width] x [height] box whose top-left is the **origin** - the pose has already been
     * translated there, so draw at `(0, 0)`, not at the widget's screen position.
     *
     * [handle] is the platform's native graphics object (`GuiGraphics` under NeoForge).
     */
