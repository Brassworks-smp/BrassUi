...
object BrassDrawScope {
    ...
    /** A snapshot of all three channels. */
    data class Saved(
        val fade: Float,
    ...
    /**
     * Run [body] with the given channels overridden, restoring all three afterwards **whatever
     * happens**. Null leaves a channel alone.
     */
    inline fun <T> with(
        fade: Float? = null,
