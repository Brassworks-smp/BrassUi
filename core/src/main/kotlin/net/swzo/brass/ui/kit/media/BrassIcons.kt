...
object BrassIcons {
    ...
    val APPLY_TO_ALL = Icon("apply_to_all")
    val BLOCK_RENDER = Icon("block_render")
    val CLICK = Icon("click")
    val COLLAPSE = Icon("collapse")
    val COPY = Icon("copy")
    val DRAG_DROP = Icon("dragndrop")
    val EXPAND_MAXIMIZED = Icon("expand_maximized")
    val EXPAND_WINDOWED = Icon("expand_windowed")
    val EYE = Icon("eye_icon")
    val EYE_CLOSED = Icon("eye_closed_icon")
    val EYEDROPPER = Icon("eyedropper")
    val FOLDER_CLOSED = Icon("folder_closed")
    val FOLDER_HALF = Icon("folder_half")
    val FOLDER_OPEN = Icon("folder_open")
    val IMPORT = Icon("import")
    val LAYER_DISTANCE = Icon("layer_distance")
    val LAYER_ICON = Icon("layer_icon")
    val LAYER_SHAPE = Icon("layer_shape")
    val LAYER_TEXT = Icon("layer_text")
    val LOCK = Icon("lock")
    val NAV_CONTROLS = Icon("nav_controls")
    val NAV_DATA = Icon("nav_data")
    val NAV_GENERAL = Icon("nav_general")
    val NAV_GLOBAL = Icon("nav_global")
    val NAV_INTEGRATIONS = Icon("nav_integrations")
    val NAV_LABEL_STYLIST = Icon("nav_label_stylist")
    val NAV_WAYPOINTS = Icon("nav_waypoints")
    val OPEN_MENU = Icon("open_menu")
    val PENCIL = Icon("pencil2")
    val RESET = Icon("reset")
    val ROTATE = Icon("rotate")
    val SHARE = Icon("share")
    val TRASH = Icon("trash16")
}
